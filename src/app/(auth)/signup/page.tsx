        ...
        <div className="bg-white border border-border rounded-[20px] p-8 shadow-sm">
          {success ? (
            <div className="text-center py-4">
              ...
              <p className="text-sm text-muted leading-relaxed mb-6">We&apos;ve sent a secure verification link to <strong className="text-ink">{email}</strong>. Open that email and click <strong className="text-ink">Verify my email</strong> to activate your account.</p>
