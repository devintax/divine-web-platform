...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      upload_links: {
        Row: { created_at: string | null; created_by: string | null; expires_at: string | null; id: string; is_active: boolean | null; purpose: string | null; recipient_email: string | null; target_user_id: string | null; token: string | null; used_at: string | null }
        Insert: { created_at?: string | null; created_by?: string | null; expires_at?: string | null; id?: string; is_active?: boolean | null; purpose?: string | null; recipient_email?: string | null; target_user_id?: string | null; token?: string | null; used_at?: string | null }
        Update: { created_at?: string | null; created_by?: string | null; expires_at?: string | null; id?: string; is_active?: boolean | null; purpose?: string | null; recipient_email?: string | null; target_user_id?: string | null; token?: string | null; used_at?: string | null }
        Relationships: []
      }
      user_profiles: {
      ...
      vault_documents: {
        Row: { category: string | null; created_at: string | null; display_name: string | null; file_name: string | null; file_size: number | null; id: string; mime_type: string | null; ocr_tags: string[] | null; routed_to: string | null; share_link_expires: string | null; share_link_token: string | null; status: string | null; storage_path: string | null; uploaded_via: string | null; user_id: string | null; virus_clean: boolean | null; virus_scanned: boolean | null }
        Insert: { category?: string | null; created_at?: string | null; display_name?: string | null; file_name?: string | null; file_size?: number | null; id?: string; mime_type?: string | null; ocr_tags?: string[] | null; routed_to?: string | null; share_link_expires?: string | null; share_link_token?: string | null; status?: string | null; storage_path?: string | null; uploaded_via?: string | null; user_id?: string | null; virus_clean?: boolean | null; virus_scanned?: boolean | null }
        Update: { category?: string | null; created_at?: string | null; display_name?: string | null; file_name?: string | null; file_size?: number | null; id?: string; mime_type?: string | null; ocr_tags?: string[] | null; routed_to?: string | null; share_link_expires?: string | null; share_link_token?: string | null; status?: string | null; storage_path?: string | null; uploaded_via?: string | null; user_id?: string | null; virus_clean?: boolean | null; virus_scanned?: boolean | null }
        Relationships: []
      }
    }
