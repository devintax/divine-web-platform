...
ARG NEXT_PUBLIC_CAL_COM_URL
ARG NEXT_PUBLIC_DOCUSEAL_URL
...
ENV NEXT_PUBLIC_CAL_COM_URL=${NEXT_PUBLIC_CAL_COM_URL}
ENV NEXT_PUBLIC_DOCUSEAL_URL=${NEXT_PUBLIC_DOCUSEAL_URL}
